...
export default function AddLiquidity({
  ...
  async function onAdd() {
    ...
    let addLiquidityTx = null
    let value = null

    if (currencyA.isNative || currencyB.isNative) {
      const tokenBIsETH = currencyB.isNative
      addLiquidityTx = v2RouterTelegramContract.methods.addLiquidityETH(
      ...
      addLiquidityTx = v2RouterTelegramContract.methods.addLiquidity(
    ...
    try {
      const response = await sendTxWithPkey(
        ...
        addTransaction,
        {
          summary: t`Add ${parsedAmounts[Field.CURRENCY_A]?.toSignificant(3)} ${currencies[Field.CURRENCY_A]?.symbol
