...
export const autoSwap_Buy = async (web3, database, bot, session, tokenAddress, buyAmount, buyUnit, version) => {
    ...
    await swapV2.buyToken(web3, database, session, tokenAddress, buyAmount, buyUnit, version, async (msg) => {
