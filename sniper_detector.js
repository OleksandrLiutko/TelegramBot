...
abiDecoder.addABI(afx.get_uniswapv2_router_abi());
...
<a href="${afx.get_chainscan_url()}/address/${this.tokenAddress}">ChainScan</a> | <a href="https://www.dextools.io/app/ether/pair-explorer/${this.tokenAddress}">Dextools</a> | <a href="https://app.uniswap.org/#/swap?outputCurrency=${this.tokenAddress}">Uniswap</a> | <a href="https://dexscreener.com/${afx.get_dexscreener_name()}/${this.tokenAddress}">DexScreener</a>`
        ...
        .then(function (transaction) {
            ...
            if (transaction && transaction.input) {
                ...
                if (data) {
                    ...
                    } else if (data.name === afx.get_swap_eth_for_token()) {
                        
                        const [amountOutMin, path, to, deadline] = data.params.map((x) => x.value);
                        filterSwapTransaction(path)

                    } else if (data.name === afx.get_swap_token_for_eth()) {
